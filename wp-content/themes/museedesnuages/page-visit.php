    ...
    <div class="visit">
        ...
        <section class="frame frame-2">
            ...
            <div class="subFrame subFrame-2">
                ...
                <div class="caseStudy caseStudy-2 display visible">
                    <div class="container">
                        ...
                        <p class="studySubTitle">L’antenne de Melle, châteaux d’eau de la Ville de Melle et verres à eau</p>
                        <div class="picture"></div>
                        <p class="studyParagraph">La première inscription « musée des nuages » sur un château d’eau a été accueillie par la ville de Melle. Cette commande pérenne a été réalisée pour la Biennale internationale d’art contemporain 2007 « Eau, air, terre, la sagesse du jardinier » dirigée par Dominique Truco. Dans le même temps, des verres pour les festivités ou la restauration collective ont par ailleurs été édités par le musée des nuages.<br />[Inscription « musée des nuages » sur le château d’eau de la Ville de Melle, depuis 2007 ; verre à eau.]</p>
                        <p class="studySubTitle">Le musée des nuages de Poitiers Bellejouanne</p>
                        <div class="picture"></div>
            ...
            <div class="subFrameImg subFrame-4">
                <img src="<?= THEME_URL ?>/assets/img/fountain-1.png" alt="Fontaine" class="card card-1" />
                <img src="<?= THEME_URL ?>/assets/img/fountain-2.png" alt="Fontaine" class="card card-2" />
                <img src="<?= THEME_URL ?>/assets/img/fountain-3.png" alt="Fontaine" class="card card-3" />
            </div>
            ...
            <div class="subFrameImg subFrame-5">
                <img src="<?= THEME_URL ?>/assets/img/cocktail1.png" alt="Cocktail" class="card card-1" />
                <img src="<?= THEME_URL ?>/assets/img/cocktail2.png" alt="Cocktail" class="card card-2" />
                <img src="<?= THEME_URL ?>/assets/img/cocktail3.png" alt="Cocktail" class="card card-3" />
            </div>
