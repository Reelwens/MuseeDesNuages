...
?>
    <div class="news">
        ...
        <div id="instagramFeed" class="socialFeed">
            <?php echo do_shortcode('[fts_instagram instagram_id=4542366144 access_token=4542366144.da06fb6.324f2118fb244cbc8e3c333871c2d15c pics_count=6 type=user profile_wrap=no]')?>
            <a href="https://twitter.com/museedes_nuages" target="blank" class="button">voir plus</a>
        </div>
