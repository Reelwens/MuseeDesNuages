...
?>
    <div class="news">
        ...
        <div id="instagramFeed" class="socialFeed">
            <?php echo do_shortcode('[fts_instagram instagram_id=4542366144 access_token=4542366144.da06fb6.324f2118fb244cbc8e3c333871c2d15c pics_count=6 type=user width=50% profile_wrap=no super_gallery=yes columns=4 force_columns=no space_between_photos=1px icon_size=65px hide_date_likes_comments=no]')?>
